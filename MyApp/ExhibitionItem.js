...
export default class ExhibitionItem extends Component{
        constructor(props){
              ...
              this.fetchSearchInformation("http://192.168.111.1/searchExhibition.php",zip);
          }
//这一页还没改完，php还没写
    render(){
     ...
     fetchSearchInformation=(url_test,zip)=>{
         ...
         formData.append("exhibitionName",text)
         ...
         .then(data =>{
            ...
            this.setState({
                time:data.exhibitionTime,
                content:data.exhibitionIntroduction,
